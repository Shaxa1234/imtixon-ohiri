  ...
  return (
    <section className="bg-[#D9ECFF]">
      <div className="container">
        ...
        <div className="flex">
          <div className="card2 w-[253px] h-[342px] inline-block items-center justify-center border mx-auto rounded-[20px] shadow-md bg-white mb-[155px]d hover:shadow-xl">
            <img
              src={img1}
              alt="img"
          ...
          <div className="card2 w-[253px] h-[342px]  inline-block items-center justify-center border mx-auto rounded-[20px] shadow-md bg-white mb-[155px] hover:shadow-xl">
            <img
              src={img2}
              alt="img"
              className="mt-[37px] mb-[50px] mx-[82px]"
          ...
          <div className="card3 w-[253px] h-[342px]  inline-block items-center justify-center border mx-auto rounded-[20px] shadow-md bg-white mb-[155px] hover:shadow-xl">
            <img
              src={img3}
              alt="img"
              className="mt-[37px] mb-[50px] mx-[82px]"
          ...
          <div className="card4 w-[253px] h-[342px]  inline-block items-center justify-center border mx-auto rounded-[20px] shadow-md bg-white mb-[155px] hover:shadow-xl">
            <img
              src={img4}
              alt="img"
              className="mt-[37px] mb-[50px] mx-[82px]"
          ...
          <div className="card5 w-[253px] h-[342px]  inline-block items-center justify-center border mx-auto rounded-[20px] shadow-md bg-white mb-[155px] hover:shadow-xl">
            <img
              src={img5}
              alt="img"
              className="mt-[37px] mb-[50px] mx-[82px]"
          ...
          <div className="card6 w-[253px]  h-[342px] inline-block items-center justify-center border mx-auto rounded-[20px] shadow-md bg-white mb-[155px] hover:shadow-xl">
            <img
              src={img6}
              alt="img"
              className="mt-[37px] mb-[50px] mx-[82px]"
